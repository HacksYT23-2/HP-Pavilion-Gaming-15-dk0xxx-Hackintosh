...
| Wi-Fi / Bluetooth | ⚠️ Untested / not documented yet |
| Sleep/Wake | ⚠️ Untested / not documented yet |
...
- Built using [OpenCore](https://github.com/acidanthera/OpenCorePkg) and the [Acidanthera](https://github.com/acidanthera) kext ecosystem
